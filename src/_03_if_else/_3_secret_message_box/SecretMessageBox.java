...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		// a variable
		String message = JOptionPane.showInputDialog("please give a message (it will be secret, maybe)");
		// 3. Now use a pop-up to tell the NEXT user that they can only see the secret
		// message
		// if they can guess the passcode
		String userGuess = JOptionPane.showInputDialog("please guess the password");
		...
		// 5. If the password does not match, pop-up "INTRUDER!!
			...
			JOptionPane.showMessageDialog(null, "INTRUDER!! enemy sighted! guards ATTTAAACKK!!!");
		}
	}
